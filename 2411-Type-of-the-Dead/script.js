...
let selectedWord = "";
let words = new Array(5);
let i = 0;
let uniqueWords;

let sndBackground = new Audio("Sounds/Background2.mp3");
let sndMatch = new Audio("Sounds/MatchDing2.mp3");
let sndSuccess = new Audio("Sounds/Success.mp3");
let sndFail = new Audio("Sounds/Fail.mp3");

document.getElementById("Word1").addEventListener("keydown", checkInput, false);
document.getElementById("Word1").addEventListener("keyup", checkInput, false);

document.getElementById("Word2").addEventListener("keydown", checkInput, false);
document.getElementById("Word2").addEventListener("keyup", checkInput, false);

document.getElementById("Word3").addEventListener("keydown", checkInput, false);
document.getElementById("Word3").addEventListener("keyup", checkInput, false);

document.getElementById("Word4").addEventListener("keydown", checkInput, false);
document.getElementById("Word4").addEventListener("keyup", checkInput, false);

document.getElementById("Word5").addEventListener("keydown", checkInput, false);
document.getElementById("Word5").addEventListener("keyup", checkInput, false);
...
function checkInput(event) {
  let timeLeft = document.querySelector("#TimeLeft").value;
  let timeMax = document.querySelector("#TimeLeft").max;
  ...
  if (timeLeft < timeMax) {
    ...
    if ( !(document.getElementById("Word1").disabled) && (document.getElementById("Word1Label").innerHTML.toLowerCase() === document.getElementById("Word1").value.toLowerCase()) ) {
      ...
      /*Place Focus on Second Input Element*/
      document.getElementById("Word2").focus();
      document.getElementById("Word2").select();
    }

    if ( !(document.getElementById("Word2").disabled) && (document.getElementById("Word2Label").innerHTML.toLowerCase() === document.getElementById("Word2").value.toLowerCase()) ) {

      sndMatch.play();

      document.getElementById("Word2").disabled = true;
      document.getElementById("Word3").disabled = false;

      /*Place Focus on Third Input Element*/
      document.getElementById("Word3").focus();
      document.getElementById("Word3").select();
    }

    if ( !(document.getElementById("Word3").disabled) && (document.getElementById("Word3Label").innerHTML.toLowerCase() === document.getElementById("Word3").value.toLowerCase()) ) {

      sndMatch.play();

      document.getElementById("Word3").disabled = true;
      document.getElementById("Word4").disabled = false;

      /*Place Focus on Fourth Input Element*/
      document.getElementById("Word4").focus();
      document.getElementById("Word4").select();
    }

    if ( !(document.getElementById("Word4").disabled) && (document.getElementById("Word4Label").innerHTML.toLowerCase() === document.getElementById("Word4").value.toLowerCase()) ) {

      sndMatch.play();

      document.getElementById("Word4").disabled = true;
      document.getElementById("Word5").disabled = false;

      /*Place Focus on Fifth Input Element*/
      document.getElementById("Word5").focus();
      document.getElementById("Word5").select();
    }

    if ( !(document.getElementById("Word5").disabled) && (document.getElementById("Word5Label").innerHTML.toLowerCase() === document.getElementById("Word5").value.toLowerCase()) ) {
      ...
      sndMatch.play();
      sndSuccess.play();
      document.getElementById("Word5").disabled = true;

      allMatched = true;
    }

    /*Disable Control and Shift Keys to Prevent Copy-Pasting*/
...
function selectWords() {
  ...
  switch (parseInt(document.getElementById("Difficulty").value)) {
    case 10:
      mn = 4;
      mx = 6;
      break;
...
function startTime() {
  ...
  let timeProgress = setInterval(moveTimeProgress, 100);
